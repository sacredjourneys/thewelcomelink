...
- Fonts in use: Newsreader (serif, for headings, with its italic used for accent words) and Hanken Grotesk (body). This "Coast editorial" pairing replaced the original Fraunces + Spline Sans across the whole site in Sept 2026, to feel more editorial and less like a default template. Google Fonts link on every page: `family=Newsreader:ital,opsz,wght@0,6..72,300;0,6..72,400;0,6..72,500;0,6..72,600;1,6..72,300;1,6..72,400&family=Hanken+Grotesk:wght@300;400;500;600;700`.
